    ...
    export const About = () => {
        return (
            <section id="about" className="About">
                ...
                <Benefits />
                <Space mt={100} />
                <QuoteBlock title="ПОСЕТИТЬ ЦЕРКОВЬ" text="Пріидите, возрадуемся Господеви, воскликнемъ Богу Спасителю нашему: предваримъ в лице Его во исповѣданіи, и во псалмѣхъ воскликнемъ Ему. Яко Богъ Велій Господь, и Царь Велій по всей земли." backgr_img={`${import.meta.env.BASE_URL}foto/deva_mariya.png`}/>
            </section>
        );
    };