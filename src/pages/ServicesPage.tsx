...
const SERVICES: ServiceItem[] = [
  {
    ...
    duration: '1 – 1.5 часа',
    image:
      'https://images.unsplash.com/photo-1548625149-fc4a29cf7092?w=640&q=80&fit=crop',
    accent: '#4a90d9',
  },
  {
    id: 'prayer',
    ...
    image:
      'https://images.unsplash.com/photo-1491466424936-e304919aada7?w=640&q=80&fit=crop',
    accent: '#c2a052',
  },
  {
    id: 'blessing',
    ...
    image:
      'https://images.unsplash.com/photo-1543791448-a6a60f9f3e98?w=640&q=80&fit=crop',
    accent: '#7ecb8f',
  },
  {
    id: 'wedding',
    ...
    duration: '1 – 2 часа',
    image:
      'https://images.unsplash.com/photo-1523438885200-e635ba2c371e?w=640&q=80&fit=crop',
    accent: '#d4a0c0',
  },
  {
    id: 'funeral',
    ...
    image:
      'https://images.unsplash.com/photo-1547570786-fc29aa13e2d2?w=640&q=80&fit=crop',
    accent: '#888ea0',
  },
  {
    id: 'confession',
    ...
    duration: '1 – 1.5 часа',
    image:
      'https://images.unsplash.com/photo-1579545032890-82aaa75b8c54?w=640&q=80&fit=crop',
    accent: '#9b7ec8',
  },
];
...
const BookingModal = ({ service, onClose, priests, getBookedSlots, onSubmit }: ModalProps) => {
  ...
  const sortedPriests = [...priests].sort(
    (a, b) => b.rating - a.rating || b.experience - a.experience,
  );
          ...
          >
            ...
            {booking.step === 2 && (
              <div className={styles.step2}>
                ...
                <p className={styles.stepHint}>Священнослужители отсортированы по рейтингу</p>
                  ...
                  {sortedPriests.map((p) => (
                    ...
                    >
                      ...
                      <div className={styles.priestInfo}>
                        ...
                        <p className={styles.priestMeta}>
                          <span className={styles.priestRating}>★ {p.rating}</span>
                          &nbsp;·&nbsp;{p.experience} лет служения
                        </p>
